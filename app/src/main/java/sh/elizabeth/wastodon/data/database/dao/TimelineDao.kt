...
interface TimelineDao {
	...
	@Query(
		...
		repostedBy.profileRow AS repostedBy_profileRow, repostedBy.profileId AS repostedBy_profileId, repostedBy.avatarUrl AS repostedBy_avatarUrl, repostedBy.avatarBlur AS repostedBy_avatarBlur, repostedBy.fullUsername AS repostedBy_fullUsername, repostedBy.headerUrl AS repostedBy_headerUrl, repostedBy.instance AS repostedBy_instance, repostedBy.name AS repostedBy_name, repostedBy.username AS repostedBy_username,
