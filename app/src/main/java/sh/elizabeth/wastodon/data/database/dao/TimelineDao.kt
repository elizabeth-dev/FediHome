...
interface TimelineDao {
	...
	@Query(
		...
		author.profileRow AS author_profileRow, author.profileId AS author_profileId, author.avatarUrl AS author_avatarUrl, author.fullUsername AS author_fullUsername, author.headerUrl AS author_headerUrl, author.instance AS author_instance, author.name AS author_name, author.username AS author_username,
		
		repostedBy.profileRow AS repostedBy_profileRow, repostedBy.profileId AS repostedBy_profileId, repostedBy.avatarUrl AS repostedBy_avatarUrl, repostedBy.fullUsername AS repostedBy_fullUsername, repostedBy.headerUrl AS repostedBy_headerUrl, repostedBy.instance AS repostedBy_instance, repostedBy.name AS repostedBy_name, repostedBy.username AS repostedBy_username,
